...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        self.tk_button_hk = self.__tk_button_hk(self)
    ...
    def __tk_button_lq7ezuaj(self,parent):
        ...
        return btn
    def __tk_button_hk(self,parent):
        btn = tk.Button(parent, text="HK BUS", takefocus=False,command = self.switch_to_window4)
        btn.place(x=243, y=123, width=150, height=30)
        return btn
    ...
    def switch_to_window4(self):
        import windowhk4 as hk4
        window4 = hk4.WinGUI()
        self.withdraw()  # 隐藏主窗口
        window4.deiconify()  # 显示窗口3
